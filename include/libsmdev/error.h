...
enum LIBSMDEV_ARGUMENT_ERROR
{
	 ...
	 */
	LIBSMDEV_ARGUMENT_ERROR_VALUE_OUT_OF_RANGE     = 7,
...
enum LIBSMDEV_COMPRESSION_ERROR
{
	 ...
	 */
	LIBSMDEV_COMPRESSION_ERROR_UNCOMPRESS_FAILED   = 2
};
...
enum LIBSMDEV_INPUT_ERROR
{
	 ...
	 */
	LIBSMDEV_INPUT_ERROR_CRC_MISMATCH              = 3,
	 ...
	 */
	LIBSMDEV_INPUT_ERROR_MISSING_LAST_SEGMENT_FILE = 5,

	/* The last section is missing from the input
	 */
	LIBSMDEV_INPUT_ERROR_MISSING_LAST_SECTION      = 6
};
...
enum LIBSMDEV_RUNTIME_ERROR
{
	 ...
	 */
	LIBSMDEV_RUNTIME_ERROR_VALUE_OUT_OF_RANGE      = 12,
