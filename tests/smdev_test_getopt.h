...
#if !defined( _SMDEV_TEST_GETOPT_H )
#define _SMDEV_TEST_GETOPT_H
...
#define smdev_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t smdev_test_getopt(
                  int argument_count,
...
#endif /* !defined( _SMDEV_TEST_GETOPT_H ) */
