...
#if !defined( _SMDEVTOOLS_GETOPT_H )
#define _SMDEVTOOLS_GETOPT_H
...
#define smdevtools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t smdevtools_getopt(
                  int argument_count,
...
#endif /* !defined( _SMDEVTOOLS_GETOPT_H ) */
