...
void (*smdevtools_signal_signal_handler)( smdevtools_signal_t ) = NULL;
...
{
	static char *function = "smdevtools_signal_handler";
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( smdevtools_signal_signal_handler != NULL )
			{
				smdevtools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "smdevtools_signal_attach";
	...
	smdevtools_signal_signal_handler = signal_handler;

	if( SetConsoleCtrlHandler(
	     (PHANDLER_ROUTINE) smdevtools_signal_handler,
	     TRUE ) == 0 )
	{
		libcerror_error_set(
		 error,
...
#if defined( _MSC_VER )
	smdevtools_signal_initialize_memory_debug();
#endif
...
int smdevtools_signal_detach(
     libcerror_error_t **error )
{
	static char *function = "smdevtools_signal_detach";
	...
	smdevtools_signal_signal_handler = NULL;
