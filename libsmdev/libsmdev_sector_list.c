...
{
	static char *function = "libsmdev_sector_list_value_initialize";
	...
	if( *sector_list_value == NULL )
	{
		*sector_list_value = memory_allocate_structure(
		...
		if( memory_set(
		     *sector_list_value,
		     0,
		     sizeof( libsmdev_sector_list_value_t ) ) == NULL )
		{
			liberror_error_set(
			 error,
			 LIBERROR_ERROR_DOMAIN_MEMORY,
...
int libsmdev_sector_list_value_free(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_sector_list_value_free";
...
int libsmdev_sector_list_value_clone(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_sector_list_value_clone";
...
int libsmdev_sector_list_initialize(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_sector_list_initialize";
	...
	if( *sector_list == NULL )
	{
		*sector_list = memory_allocate_structure(
		...
		if( memory_set(
		     *sector_list,
		     0,
		     sizeof( libsmdev_sector_list_t ) ) == NULL )
		{
			liberror_error_set(
			 error,
			 LIBERROR_ERROR_DOMAIN_MEMORY,
...
int libsmdev_sector_list_free(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_sector_list_free";
	int result            = 1;
	...
	if( *sector_list != NULL )
	{
		result = libsmdev_sector_list_empty(
		          *sector_list,
		          error );
     ...
     liberror_error_t **error )
{
	...
	static char *function                 = "libsmdev_sector_list_empty";
	int element_index                     = 0;
     ...
     liberror_error_t **error )
{
	...
	static char *function                             = "libsmdev_sector_list_clone";
	int element_index                                 = 0;
	     ...
	     element_index++ )
	{
		...
		if( libsmdev_sector_list_value_clone(
		     &destination_value,
...
int libsmdev_sector_list_get_number_of_elements(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_sector_list_get_number_of_elements";
     ...
     liberror_error_t **error )
{
	...
	static char *function                           = "libsmdev_sector_list_append_sector";
	...
	else if( sector_list->number_of_elements > 0 )
	{
		...
		sector_list_value = (libsmdev_sector_list_value_t *) list_element->value;
		...
		if( merge_previous_list_element_check != 0 )
		{
			...
			if( list_element->previous_element != NULL )
			{
				...
				last_sector = ( (libsmdev_sector_list_value_t *) list_element->previous_element->value )->first_sector
				            + ( (libsmdev_sector_list_value_t *) list_element->previous_element->value )->number_of_sectors;

				if( last_sector == sector_list_value->first_sector )
				{
					/* Merge sector range with previous
					 */
					sector_list_value->first_sector       = ( (libsmdev_sector_list_value_t *) list_element->previous_element->value )->first_sector;
					sector_list_value->number_of_sectors += ( (libsmdev_sector_list_value_t *) list_element->previous_element->value )->number_of_sectors;
		...
		if( merge_next_list_element_check != 0 )
		{
			...
			if( list_element->next_element != NULL )
			{
				...
				if( last_sector == ( (libsmdev_sector_list_value_t *) list_element->next_element->value )->first_sector )
				{
					/* Merge sector range with next
					 */
					sector_list_value->number_of_sectors += ( (libsmdev_sector_list_value_t *) list_element->next_element->value )->number_of_sectors;
	...
	if( create_list_element != 0 )
	{
		...
		if( libsmdev_sector_list_value_initialize(
		     &sector_list_value,
		     error ) != 1 )
		{
			liberror_error_set(
     ...
     liberror_error_t **error )
{
	...
	sector_list_value = (libsmdev_sector_list_value_t *) sector_list->current_element->value;
     ...
     liberror_error_t **error )
{
	libsmdev_list_element_t *list_element           = NULL;
	libsmdev_sector_list_value_t *sector_list_value = NULL;
	static char *function                           = "libsmdev_sector_list_get_sector_by_value";
	int element_index                               = 0;
     ...
     liberror_error_t **error )
{
	libsmdev_list_element_t *list_element           = NULL;
	libsmdev_sector_list_value_t *sector_list_value = NULL;
	static char *function                           = "libsmdev_sector_list_range_is_present";
	uint64_t last_sector                            = 0;
	int element_index                               = 0;
