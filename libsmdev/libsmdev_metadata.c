 ...
 * Returns 1 if successful or -1 on error
 */
int internal_handle_set_read_error_values(
     internal_handle_t *internal_handle,
     int8_t read_error_retry,
     uint32_t byte_error_granularity,
     uint8_t wipe_block_on_read_error,
     liberror_error_t **error )
{
	static char *function = "internal_handle_set_read_error_values";
	...
	internal_handle->read_error_retry         = read_error_retry;
	internal_handle->byte_error_granularity   = byte_error_granularity;
	internal_handle->wipe_block_on_read_error = wipe_block_on_read_error;

	return( 1 );
}

/* Retrieves the amount of read error retries
 * Returns the 1 if succesful or -1 on error
 */
int libsmio_device_get_read_error_retries(
     ...
     liberror_error_t **error )
{
	...
	static char *function                        = "libsmio_device_get_read_error_retries";
	...
	device_io_handle = (libsmio_device_io_handle_t *) internal_handle->io_handle;

	if( read_error_retries == NULL )
	{
		liberror_error_set(
		 error,
		 LIBERROR_ERROR_DOMAIN_ARGUMENTS,
		 LIBERROR_ARGUMENT_ERROR_INVALID_VALUE,
		 "%s: invalid read error retries.",
		 function );

		return( -1 );
	}
	*read_error_retries = device_io_handle->read_error_retries;

	return( 1 );
}

/* Sets the amount of read error retries
 * Returns the 1 if succesful or -1 on error
 */
int libsmio_device_set_read_error_retries(
     libsmio_handle_t *handle,
     int read_error_retries,
     liberror_error_t **error )
{
	libsmio_device_io_handle_t *device_io_handle = NULL;
	libsmio_internal_handle_t *internal_handle   = NULL;
	static char *function                        = "libsmio_device_set_read_error_retries";
	...
	device_io_handle->read_error_retries = read_error_retries;

	return( 1 );
}

/* Retrieves the clear buffer on read error value
 * Returns the 1 if succesful or -1 on error
 */
int libsmio_device_get_clear_buffer_on_read_error(
     libsmio_handle_t *handle,
     ...
     liberror_error_t **error )
{
	libsmio_device_io_handle_t *device_io_handle = NULL;
	libsmio_internal_handle_t *internal_handle   = NULL;
	static char *function                        = "libsmio_device_get_clear_buffer_on_read_error";
	...
	if( clear_buffer_on_read_error == NULL )
	{
		liberror_error_set(
		 error,
		 LIBERROR_ERROR_DOMAIN_ARGUMENTS,
		 LIBERROR_ARGUMENT_ERROR_INVALID_VALUE,
		 "%s: invalid clear buffer on read error.",
		 function );

		return( -1 );
	}
	*clear_buffer_on_read_error = device_io_handle->clear_buffer_on_read_error;

	return( 1 );
}

/* Sets the clear buffer on read error value
 * Returns the 1 if succesful or -1 on error
 */
int libsmio_device_set_clear_buffer_on_read_error(
     libsmio_handle_t *handle,
     int clear_buffer_on_read_error,
     liberror_error_t **error )
{
	libsmio_device_io_handle_t *device_io_handle = NULL;
	libsmio_internal_handle_t *internal_handle   = NULL;
	static char *function                        = "libsmio_device_set_clear_buffer_on_read_error";
	...
	device_io_handle->clear_buffer_on_read_error = clear_buffer_on_read_error;
