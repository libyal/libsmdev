...
{
	static char *function = "libsmdev_list_element_initialize";
	...
	if( *element == NULL )
	{
		*element = (libsmdev_list_element_t *) memory_allocate(
		                                        sizeof( libsmdev_list_element_t ) );
		...
		if( memory_set(
		     *element,
		     0,
		     sizeof( libsmdev_list_element_t ) ) == NULL )
		{
			liberror_error_set(
			 error,
			 LIBERROR_ERROR_DOMAIN_MEMORY,
...
int libsmdev_list_element_free(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_list_element_free";
	int result            = 1;
...
int libsmdev_list_element_get_value(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_list_element_get_value";
...
int libsmdev_list_element_set_value(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_list_element_set_value";
...
int libsmdev_list_initialize(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_list_initialize";
	...
	if( *list == NULL )
	{
		*list = (libsmdev_list_t *) memory_allocate(
		                             sizeof( libsmdev_list_t ) );
...
int libsmdev_list_free(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_list_free";
	int result            = 0;
     ...
     liberror_error_t **error )
{
	...
	static char *function                 = "libsmdev_list_empty";
	int element_index                     = 0;
...
int libsmdev_list_get_number_of_elements(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_list_get_number_of_elements";
...
{
	libsmdev_list_element_t *list_element = NULL;
	static char *function                 = "libsmdev_list_get_element_by_index";
...
{
	libsmdev_list_element_t *list_element = NULL;
	static char *function                 = "libsmdev_list_get_value_by_index";
	int result                            = 0;

	result = libsmdev_list_get_element_by_index(
	          list,
	          element_index,
	          &list_element,
	          error );
	...
	if( libsmdev_list_element_get_value(
	     list_element,
	     value,
	     error ) != 1 )
	{
...
int libsmdev_list_prepend_element(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_list_prepend_element";
...
{
	libsmdev_list_element_t *list_element = NULL;
	static char *function                 = "libsmdev_list_prepend_value";
...
int libsmdev_list_append_element(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_list_append_element";
...
{
	libsmdev_list_element_t *list_element = NULL;
	static char *function                 = "libsmdev_list_append_value";
 ...
 * The value_compare_function should return LIBSMDEV_LIST_COMPARE_LESS,
 * LIBSMDEV_LIST_COMPARE_EQUAL, LIBSMDEV_LIST_COMPARE_GREATER if successful or -1 on error
 *
 * Duplicate entries are allowed by default and inserted after the last duplicate value.
 * Only allowing unique entries can be enforced by setting the flag LIBSMDEV_LIST_INSERT_FLAG_UNIQUE_ENTRIES
 *
...
{
	libsmdev_list_element_t *list_element = NULL;
	static char *function                 = "libsmdev_list_insert_element";
	int element_index                     = 0;
	int result                            = -1;
	...
	if( ( insert_flags & ~( LIBSMDEV_LIST_INSERT_FLAG_UNIQUE_ENTRIES ) ) != 0 )
	{
		liberror_error_set(
		 error,
		 LIBERROR_ERROR_DOMAIN_ARGUMENTS,
	...
	else
	{
		     ...
		     element_index++ )
		{
			...
			else if( result == LIBSMDEV_LIST_COMPARE_EQUAL )
			{
				if( ( insert_flags & LIBSMDEV_LIST_INSERT_FLAG_UNIQUE_ENTRIES ) != 0 )
				{
					return( 0 );
			...
			else if( result == LIBSMDEV_LIST_COMPARE_LESS )
			{
				break;
			}
			else if( result != LIBSMDEV_LIST_COMPARE_GREATER )
			{
				liberror_error_set(
				 error,
				 LIBERROR_ERROR_DOMAIN_ARGUMENTS,
		...
		if( result == LIBSMDEV_LIST_COMPARE_LESS )
		{
...
{
	libsmdev_list_element_t *list_element = NULL;
	static char *function                 = "libsmdev_list_insert_value";
	int result                            = 0;
...
int libsmdev_list_remove_element(
     ...
     liberror_error_t **error )
{
	static char *function = "libsmdev_list_remove_element";
