     ...
     liberror_error_t **error )
{
	...
	if( *list_element == NULL )
	{
		*list_element = (libsmdev_list_element_t *) memory_allocate(
     ...
     liberror_error_t **error )
{
	...
	{
		*destination = (libsmdev_list_t *) memory_allocate(
		                                    sizeof( libsmdev_list_t ) );
...
{
	libsmdev_list_element_t *list_element = NULL;
	static char *function                 = "libsmdev_list_get_element";
	int iterator                          = 0;
...
{
	libsmdev_list_element_t *list_element = NULL;
	static char *function                 = "libsmdev_list_get_value";
	int result                            = 0;
...
int libsmdev_list_prepend_value(
     ...
     liberror_error_t **error )
{
	libsmdev_list_element_t *element = NULL;
